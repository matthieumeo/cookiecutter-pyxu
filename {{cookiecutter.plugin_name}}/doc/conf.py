...
def pkg_info() -> cabc.Mapping:
    ...
    """
    sphinx_src_dir = plib.Path(__file__).parent
    info_path = sphinx_src_dir / ".." / "src" / "{{cookiecutter.module_name}}.egg-info" / "PKG-INFO"
...
html_title = "{{ cookiecutter.module_name }} Documentation"
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/{{ cookiecutter.module_name }}/",
            "icon": "fa-brands fa-python",
        },
        {
            "name": "Contact",
            "url": "mailto: {{cookiecutter.email}}",
...
html_context = {
    ...
    "github_repo": "{{cookiecutter.github_repository_url}}",
    "github_version": "main",
    "doc_path": "doc",
    "default_mode": "light",
}
