...
class GradientDescent(pyca.Solver):
    ...
    **Remark 3:**
    ...
    References
    ----------
    [Nesterov] Nesterov, Yurii Evgen'evich. "A method of solving a convex programming problem with convergence rate
    O\bigl(k^2\bigr)." Doklady Akademii Nauk. Vol. 269. No. 3. Russian Academy of Sciences, 1983.
    """
